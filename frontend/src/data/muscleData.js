const baseVideos = {
  bench: { title: "Bench Press Technique", duration: "8:42", youtubeId: "SCVCLChPQFY" },
  incline: { title: "Incline Dumbbell Press", duration: "6:30", youtubeId: "8iPEnn-ltC8" },
  fly: { title: "Cable Fly Setup", duration: "4:18", youtubeId: "eozdVDA78K0" },
  ohp: { title: "Overhead Press Masterclass", duration: "9:14", youtubeId: "2yjwXTZQDDI" },
  latraise: { title: "Perfect Lateral Raise", duration: "5:51", youtubeId: "3VcKaXpzqRo" },
  facepull: { title: "Face Pull for Shoulder Health", duration: "5:03", youtubeId: "eIq5CB9JfKE" },
  curl: { title: "Barbell Curl Fundamentals", duration: "7:02", youtubeId: "kwG2ipFRgfo" },
  hammercurl: { title: "Hammer Curl Form", duration: "4:25", youtubeId: "zC3nLlEvin4" },
  pushdown: { title: "Pushdown Setup and Form", duration: "4:37", youtubeId: "2-LAMcpzODU" },
  skullcrusher: { title: "Skull Crusher Technique", duration: "5:55", youtubeId: "d_KZxkY_0cM" },
  forearm: { title: "Forearm Growth Basics", duration: "5:04", youtubeId: "Ej4WzltO1DA" },
  latpull: { title: "Lat Pulldown Cues", duration: "6:01", youtubeId: "CAwf7n6Luuc" },
  pullup: { title: "Pull-Up Form", duration: "7:07", youtubeId: "eGo4IYlbE5g" },
  shrug: { title: "Barbell Shrug Form", duration: "3:56", youtubeId: "Y6m6A6X3Gf0" },
  deadlift: { title: "Romanian Deadlift Guide", duration: "7:18", youtubeId: "jEy_czb3RKA" },
  squat: { title: "Squat Depth and Form", duration: "8:11", youtubeId: "ultWZbUMPL8" },
  lunge: { title: "Walking Lunge Form", duration: "4:29", youtubeId: "wrwwXE_x-pQ" },
  hipthrust: { title: "Barbell Hip Thrust Form", duration: "6:16", youtubeId: "LM8XHLYJoYs" },
  calf: { title: "Standing Calf Raise Form", duration: "3:38", youtubeId: "YMmgqO8Jo-k" },
  crunch: { title: "Cable Crunch Technique", duration: "4:44", youtubeId: "AV5PmZJIrrw" },
  reverseCrunch: { title: "Reverse Crunch Guide", duration: "4:14", youtubeId: "JB2oyawG9KI" },
  woodchop: { title: "Cable Wood Chop Tutorial", duration: "4:39", youtubeId: "Y6h6qkNf5HE" },
};

function plan(name, sets, reps) {
...
export const MUSCLE_DATA = {
  chest_upper: {
    name: "Chest (Upper)",
    view: "front",
    description: "Clavicular pec fibers for incline pressing and upper chest fullness.",
    exercises: [
      plan("Incline Dumbbell Press", "4", "8-12"),
      plan("Low-to-High Cable Fly", "3", "12-15"),
      plan("Incline Push-Up", "3", "AMRAP"),
    ],
    videos: [baseVideos.incline, baseVideos.fly],
  },
  chest_middle: {
    name: "Chest (Middle)",
    view: "front",
    description: "Main horizontal pressing region for strength and mass.",
    exercises: [
      plan("Barbell Bench Press", "4", "5-8"),
      plan("Dumbbell Bench Press", "3", "8-12"),
      plan("Machine Press", "3", "10-12"),
    ],
    videos: [baseVideos.bench, baseVideos.fly],
  },
  chest_lower: {
    name: "Chest (Lower)",
    view: "front",
    description: "Lower pec fibers emphasized by decline and dip mechanics.",
    exercises: [
      plan("Decline Press", "4", "8-10"),
      plan("Chest Dips", "3", "8-15"),
      plan("High-to-Low Cable Fly", "3", "12-15"),
    ],
    videos: [baseVideos.bench, baseVideos.fly],
  },
  shoulder_front: {
    name: "Front Delts",
    view: "front",
    description: "Anterior deltoid for pressing and shoulder flexion.",
    exercises: [
      plan("Overhead Press", "4", "5-8"),
      plan("Front Raise", "3", "10-15"),
      plan("Arnold Press", "3", "8-12"),
    ],
    videos: [baseVideos.ohp],
  },
  shoulder_lateral: {
    name: "Lateral Delts",
    view: "front",
    description: "Side shoulder cap for width and overhead stability.",
    exercises: [
      plan("Lateral Raise", "4", "12-20"),
      plan("Cable Lateral Raise", "3", "12-15"),
      plan("Upright Row", "3", "8-12"),
    ],
    videos: [baseVideos.latraise],
  },
  shoulder_rear: {
    name: "Rear Delts",
    view: "back",
    description: "Posterior shoulder for posture and pulling balance.",
    exercises: [
      plan("Reverse Fly", "4", "12-20"),
      plan("Face Pull", "3", "12-15"),
      plan("Rear Delt Row", "3", "10-12"),
    ],
    videos: [baseVideos.facepull],
  },
  biceps: {
    name: "Biceps",
    view: "front",
    description: "Elbow flexors supporting curls and pulling strength.",
    exercises: [
      plan("Barbell Curl", "4", "8-12"),
      plan("Incline Curl", "3", "10-12"),
      plan("Hammer Curl", "3", "10-12"),
    ],
    videos: [baseVideos.curl, baseVideos.hammercurl],
  },
  triceps: {
    name: "Triceps",
    view: "back",
    description: "Primary elbow extensor for pressing lockout and arm size.",
    exercises: [
      plan("Triceps Pushdown", "4", "10-15"),
      plan("Skull Crusher", "3", "8-12"),
      plan("Close-Grip Bench", "3", "6-10"),
    ],
    videos: [baseVideos.pushdown, baseVideos.skullcrusher],
  },
  forearms: {
    name: "Forearms",
    view: "front",
    description: "Grip and wrist control muscles for pulls and carries.",
    exercises: [
      plan("Wrist Curl", "3", "15-20"),
      plan("Reverse Curl", "3", "10-12"),
      plan("Farmer Carry", "4", "30-40 sec"),
    ],
    videos: [baseVideos.forearm],
  },
  abs_upper: {
    name: "Abs (Upper)",
    view: "front",
    description: "Upper rectus abdominis for trunk flexion and compression control.",
    exercises: [
      plan("Cable Crunch", "4", "10-15"),
      plan("Swiss Ball Crunch", "3", "12-20"),
      plan("Hollow Body Hold", "3", "20-40 sec"),
    ],
    videos: [baseVideos.crunch],
  },
  abs_lower: {
    name: "Abs (Lower)",
    view: "front",
    description: "Lower rectus focus for pelvic control and lower-core tension.",
    exercises: [
      plan("Reverse Crunch", "4", "12-20"),
      plan("Hanging Knee Raise", "3", "10-15"),
      plan("Dead Bug", "3", "8-12 per side"),
    ],
    videos: [baseVideos.reverseCrunch],
  },
  obliques: {
    name: "Obliques",
    view: "front",
    description: "Lateral core for anti-rotation, rotation and torso stability.",
    exercises: [
      plan("Cable Wood Chop", "4", "10-14 per side"),
      plan("Side Plank", "3", "30-45 sec per side"),
      plan("Russian Twist", "3", "16-24 total"),
    ],
    videos: [baseVideos.woodchop],
  },
  back_lats: {
    name: "Back (Lats)",
    view: "back",
    description: "Large pulling muscles driving back width.",
    exercises: [
      plan("Lat Pulldown", "4", "8-12"),
      plan("Pull-Up", "4", "6-10"),
      plan("Single-Arm Row", "3", "10-12"),
    ],
    videos: [baseVideos.latpull, baseVideos.pullup],
  },
  back_traps: {
    name: "Back (Traps)",
    view: "back",
    description: "Upper-back stabilizers for posture and scapular control.",
    exercises: [
      plan("Barbell Shrug", "4", "10-15"),
      plan("Face Pull", "3", "12-15"),
      plan("Trap-3 Raise", "3", "12-15"),
    ],
    videos: [baseVideos.shrug, baseVideos.facepull],
  },
  back_lower: {
    name: "Back (Lower)",
    view: "back",
    description: "Lumbar erectors for hinge strength and trunk extension.",
    exercises: [
      plan("Romanian Deadlift", "4", "6-10"),
      plan("Back Extension", "3", "12-15"),
      plan("Good Morning", "3", "8-10"),
    ],
    videos: [baseVideos.deadlift],
  },
  glutes: {
    name: "Glutes",
    view: "back",
    description: "Hip extensor complex for athletic power and pelvic control.",
    exercises: [
      plan("Hip Thrust", "4", "8-12"),
      plan("Bulgarian Split Squat", "3", "8-12"),
      plan("Glute Bridge", "3", "12-15"),
    ],
    videos: [baseVideos.hipthrust, baseVideos.lunge],
  },
  quads: {
    name: "Quads",
    view: "front",
    description: "Anterior thigh group for squat/lunge knee extension.",
    exercises: [
      plan("Back Squat", "4", "5-8"),
      plan("Leg Press", "3", "10-15"),
      plan("Walking Lunge", "3", "10-14 per leg"),
    ],
    videos: [baseVideos.squat, baseVideos.lunge],
  },
  hamstrings: {
    name: "Hamstrings",
    view: "back",
    description: "Posterior thigh group for hinging and sprinting force.",
    exercises: [
      plan("Romanian Deadlift", "4", "6-10"),
      plan("Leg Curl", "3", "10-15"),
      plan("Good Morning", "3", "8-10"),
    ],
    videos: [baseVideos.deadlift],
  },
