          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[var(--bg-primary)] border border-[var(--border)] rounded-2xl p-8 group hover:border-[var(--accent)]/50 transition-all duration-300 hover:scale-[1.02]">
              ...
              <p className="text-[var(--text-secondary)] leading-relaxed mb-6">
                Build daily meal logs, monitor calories/macros, and stay aligned
                with your personalized health targets.
              </p>
              <Link
                to={isLoggedIn ? "/nutrition" : "/food-search"}
              ...
              >
                {isLoggedIn ? "Open Nutrition" : "Try Food Search"}
            ...
            <div className="bg-[var(--bg-primary)] border border-[var(--border)] rounded-2xl p-8 group hover:border-[var(--accent)]/50 transition-all duration-300 hover:scale-[1.02]">
              ...
              <p className="text-[var(--text-secondary)] leading-relaxed mb-6">
                Complete onboarding once and get training + nutrition defaults
                built for your level and schedule.
              </p>
              <Link
                to={isLoggedIn ? "/onboarding" : "/login"}
                className="inline-flex items-center text-[var(--accent)] font-medium hover:text-[var(--accent-hover)] transition-colors duration-200"
              >
                {isLoggedIn ? "Configure plan" : "Sign in to configure plan"}
                <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
            </div>
            ...
            <div className="bg-[var(--bg-primary)] border border-[var(--border)] rounded-2xl p-8 group hover:border-[var(--accent)]/50 transition-all duration-300 hover:scale-[1.02]">
              ...
              <p className="text-[var(--text-secondary)] leading-relaxed mb-6">
                Review weekly adherence, calories, and workout consistency with
                a single performance hub.
              </p>
              <Link
                to={isLoggedIn ? "/progress" : "/login"}
                className="inline-flex items-center text-[var(--accent)] font-medium hover:text-[var(--accent-hover)] transition-colors duration-200"
              >
                {isLoggedIn ? "View progress" : "Sign in to view progress"}
                <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
            </div>
          </div>
